...
final class CashinCest
{
    ...
    public function checkInvalidPhoneNumber(AcceptanceTester $I)
    {
        ...
        $I->seeResponseCodeIs(400); // Assuming 400 is the error code for bad request
        $I->seeResponseIsJson();
        $I->seeResponseContainsJson([
            "code" => 703100,
   ...
   public function checkMissingApiKey(AcceptanceTester $I)
   {
    ...
    // Check error response
    $I->seeResponseCodeIs(401); // Assuming 401 is the error code for unauthorized
    $I->seeResponseIsJson();
    $I->seeResponseContainsJson([
        "code" => 702401,
   ...
   public function checkMissingApiVersion(AcceptanceTester $I)
   {
    ...
    // Check error response
    $I->seeResponseCodeIs(401); // Assuming 401 is the error code for bad request
    $I->seeResponseIsJson();
    $I->seeResponseContainsJson([
        "code" => 702010,
